...
//here it is decided whether to have a running man and a chasing drone or not.
  ...
  object{Fancy_Pillar_basic_top scale GENERAL_SCALE translate<82, -11 + 45 - 65 * clock*clock, -57> pigment{color rgb<0.8,1,0.2> }}
  ...
  object{Fancy_Pillar_basic_top scale GENERAL_SCALE translate<79, 40 - 100 * clock*clock, -54> pigment{color rgb<1,0,0> }}
